...
function HoloPlay(scene, camera, renderer, focalPointVector, constantCenter, hiResRender){
    ...
    var defaultCalibration = {"configVersion":"1.0","serial":"00112","pitch":{"value":49.825218200683597},"slope":{"value":5.2160325050354},"center":{"value":-0.23396748304367066},"viewCone":{"value":40.0},"invView":{"value":1.0},"verticalAngle":{"value":0.0},"DPI":{"value":338.0},"screenW":{"value":2560.0},"screenH":{"value":1600.0},"flipImageX":{"value":0.0},"flipImageY":{"value":0.0},"flipSubp":{"value":0.0}};
    ...
    function makeFullScreenButton(){
        var newHTML =
            '<input type="button" style="margin:20px; position:fixed; top:0px; left:0px; z-index: 10000; height:50px; width:150px;" id="fullscreenButton" value="Enter Full Screen Mode"/>';
    ...
    function captureViews(scene, camera, renderer)
    {
        ...
        renderer.render(scene, arraycamera, bufferSceneRender);
    };
